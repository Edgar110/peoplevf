...
<body onload="">
<?php
      if(!isset($_SESSION['nombre'])) // If session is not set then redirect to Login Page
       {
...
<div id="if"></div>
<div class="container-fluid" id="contenImg" style="display:none">
<div class="col-md-4">
</div>
<div class="col-md-6" id="Imgfinal">
</div>
</div>
